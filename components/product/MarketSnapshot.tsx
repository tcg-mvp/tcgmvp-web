  ...
  return (
    <>
      <section className="market-snapshot">
        <div className="snapshot-heading">
          <div>
            ...
            <p>
              A quick view of recent sales,
              active supply, and current asking
              prices.
            </p>
          </div>
      ...
      <FairValue
        ...
        medianSale={
          fairValueResult.medianSale
        }

        averageSale={
          fairValueResult.averageSale
        }

        lowestSale={
          fairValueResult.lowestSale
        }

        highestSale={
          fairValueResult.highestSale
        }

        salesCount={
          fairValueResult.salesCount
        }

    ...
    <section className="price-target-card">
      <div className="price-target-header">
        <div>
          ...
          <p>
            ...
            market direction, risk, and evidence confidence.
          </p>
        </div>
      ...
      {hasTarget ? (
        <>
          <div className="price-target-hero">
            ...
            <div className="price-target-upside">
              ...
              <small>
                From the best available entry price
              </small>
            </div>
          </div>
        ...
        <div className="price-target-empty">
          ...
          <p>
            TCGMVP requires a valid actionable entry price
            and Fair Value before producing a forward-looking
            target.
          </p>
